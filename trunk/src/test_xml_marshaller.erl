...
xml_marshall_empty_test() ->
	...
	Marshalled = xml_marshaller:marshal(IsoMsg),
	IsoMsg = xml_unmarshaller:unmarshal(Marshalled).

xml_marshall_simple_test() ->
	IsoMsg1 = iso8583_message:new(),
	IsoMsg2 = iso8583_message:set(0, "0200", IsoMsg1),
	Marshalled = xml_marshaller:marshal(IsoMsg2),
	IsoMsg2 = xml_unmarshaller:unmarshal(Marshalled).
...
xml_marshall_binary_test() ->
	...
	Marshalled = xml_marshaller:marshal(IsoMsg3),
	IsoMsg3 = xml_unmarshaller:unmarshal(Marshalled).
