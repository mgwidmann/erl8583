...
mti_only_test() ->
	...
	"0200" ++ X = marshaller_ascii:marshal(Msg2),
	Msg3 = iso8583_message:set(0, "0210", Msg1),
	"0210" ++ X = marshaller_ascii:marshal(Msg3).

pan_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(2, "5234567890123456", Msg2),	
	"02004000000000000000165234567890123456" = marshaller_ascii:marshal(Msg3).

proc_code_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0100", Msg1),
	Msg3 = iso8583_message:set(3, "01234", Msg2),	
	"01002000000000000000001234" = marshaller_ascii:marshal(Msg3).

amount_tran_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(4, "30000", Msg2),	
	"02001000000000000000000000030000" = marshaller_ascii:marshal(Msg3).
	
amount_settle_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(5, "1", Msg2),	
	"02000800000000000000000000000001" = marshaller_ascii:marshal(Msg3).
...
fields_5_6_7_test() ->
	...
	"02000E000000000000000000000000010000000000020131081200" = marshaller_ascii:marshal(Msg5).
...
fields_8_9_10_test() ->
	...
	"130001C0000000000000000000010000000200000003" = marshaller_ascii:marshal(Msg5).
...
fields_11_12_13_14_test() ->
	...
	"0200003C00000000000000123415075520121206" = marshaller_ascii:marshal(Msg6).
...
fields_21_to_25_test() ->
	...
	"020000000F800000000000100200300405" = marshaller_ascii:marshal(Msg7).
...
fields_36_37_38_test() ->
	...
	"0200000000001C0000000101234567890Query123456 123   " = marshaller_ascii:marshal(Msg5).

field_39_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(39, "R7", Msg2),
	"02000000000002000000R7" = marshaller_ascii:marshal(Msg3).

field_40_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(?SERVICE_RESTRICTION_CODE, "R 1", Msg2),
	"02000000000001000000R 1" = marshaller_ascii:marshal(Msg3).
	
field_41_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(41, "Term#1", Msg2),
	"02000000000000800000Term#1  " = marshaller_ascii:marshal(Msg3).

field_42_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(?CARD_ACCEPTOR_ID_CODE, "CA ID 123", Msg2),
	"02000000000000400000CA ID 123      " = marshaller_ascii:marshal(Msg3).

field_43_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(43, "NAME                                  ZA", Msg2),
	"02000000000000200000NAME                                  ZA" = marshaller_ascii:marshal(Msg3).

field_44_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(44, "Foo123", Msg2),
	"0200000000000010000006Foo123" = marshaller_ascii:marshal(Msg3).
	
field_45_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(?TRACK_1_DATA, "Foo123", Msg2),
	"0200000000000008000006Foo123" = marshaller_ascii:marshal(Msg3).
...
field_46_test() ->
	...
	"02004000000000040000195234567890123456789013Hello, world!" = marshaller_ascii:marshal(Msg4).
...
fields_47_48_test() ->
	...
	"02000000000000030000006Hello!008Goodbye!" = marshaller_ascii:marshal(Msg4).
...
fields_49_50_51_test() ->
	...
	"0200000000000000E000A  B  C  " = marshaller_ascii:marshal(Msg5).

field_52_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(52, <<253, 0, 1, 2, 3, 4, 5, 127>>, Msg2),
	"02000000000000001000FD0001020304057F" = marshaller_ascii:marshal(Msg3).
...
field_53_test() ->
	...
	"020040000000000008001952345678901234567890000000000000017" = marshaller_ascii:marshal(Msg4).
...
field_54_test() ->
	...
	"02004000000000000400195234567890123456789017Additi0nal Am0unt" = marshaller_ascii:marshal(Msg4).
...
fields_55_56_57_test() ->
	...
	"02004000000000000380195234567890123456789002A1003B22004C333" = marshaller_ascii:marshal(Msg6).
	
field_64_test() ->
	Msg1 = iso8583_message:new(),
	Msg2 = iso8583_message:set(0, "0200", Msg1),
	Msg3 = iso8583_message:set(64, <<128, 255, 1, 2, 3, 4, 5, 127>>, Msg2),
	"0200000000000000000180FF01020304057F" = marshaller_ascii:marshal(Msg3).
...
fields_67_to_70_test() ->
	...
	"020080000000000000003C0000000000000001002003004" = marshaller_ascii:marshal(Msg6).
...
fields_71_72_test() ->
	...
	"02008000000000000000030000000000000000010002" = marshaller_ascii:marshal(Msg4).
...
fields_74_to_77_test() ->
	...
	"0200800000000000000000780000000000000000000001000000002200000003330000004444" = marshaller_ascii:marshal(Msg6).
...
fields_83_to_90_test() ->
	...
	"0200800000000000000000003FC0000000000000000000010000000000220000000003330000000000004444000000000005555500000000006666660000000007777777000000000000000000000000000000000088888888" = marshaller_ascii:marshal(Msg10).
...
fields_95_96_test() ->
	...
	"0200800000000000000000000003000000001                                         01000000000000FF" = marshaller_ascii:marshal(Msg4).
...
fields_99_100_test() ->
	...
	"0200800000000000000000000000300000000211042222" = marshaller_ascii:marshal(Msg4).
...
custom_marshaller_test() ->
	...
	"02003000000000000000Field 3Field 4" = marshaller_ascii:marshal(Msg4, ?MODULE).
