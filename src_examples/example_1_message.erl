...
test() ->
	...
	% Field 127 is a message containing subfields 127.2 and 127.3.
	% Notice that we use two different ways of setting the value of a subfield.
	% The way we set subfield 127.3 is the preferred idiom.
	...
	% Display fields 0, 43, 64, 127.2 and 127.3.
	...
	io:format("Field 127.3:                 ~s~n", [erl8583_message:get([127, 3], Msg6)]).
