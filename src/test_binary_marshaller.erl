...
mti_only_test() ->
	...
	<<2, 0>> = marshaller_binary:marshal(Msg2),
	Msg3 = erl8583_message:set(0, "0210", Msg1),
	<<2, 16>> = marshaller_binary:marshal(Msg3).
...
field_2_test() ->
	...
	<<2, 16, 64, 0, 0, 0, 0, 0, 0, 0, 23, 21, 35, 69, 103, 137, 1, 35, 69, 96>> 
		= marshaller_binary:marshal(Msg3).
...
fields_35_36b_test() ->
	...
	<<2, 33, 0, 0, 0, 0, 48, 0, 0, 0, 4, 177, 47, 1, 4, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 
		...
		65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 
	    65, 65, 65, 65, 65, 65, 65, 65, 65>> = marshaller_binary:marshal(Msg4).
...
custom_marshaller_test() ->
	...
	<<2, 0, 48, 0, 0, 0, 0, 0, 0, 0, 3, 4>> 
		= marshaller_binary:marshal(Msg4, ?MODULE).
